...
TermBridge changes one Windows-only call: `CreatePseudoConsole` uses flags `0`
...
TermBridge passes xterm-compatible VT input bytes directly to the PTY master.
