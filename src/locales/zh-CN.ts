export default {
  ...
  'terminal.newTab': '新终端',
  'terminal.newTabMenu.searchPlaceholder': '搜索主机或标签',
  'terminal.newTabMenu.workspaceTemplates': '工作区模板',
  'terminal.newTabMenu.newConnectionTemplate': '新建连接模板',
  'terminal.newTabMenu.connectionCount': '{count} 个连接',
  'terminal.newTabMenu.recentConnections': '最近连接',
  'terminal.newTabMenu.newConnection': '新建连接',
  'terminal.newTabMenu.openWorkbench': '打开工作台',
  'terminal.newTabMenu.personal': '个人',
