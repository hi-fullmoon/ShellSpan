export default {
  ...
  'terminal.newTabMenu.searchPlaceholder': 'Search hosts or tabs',
  'terminal.newTabMenu.workspaceTemplates': 'Workspace templates',
  'terminal.newTabMenu.newConnectionTemplate': 'New Connection Template',
  'terminal.newTabMenu.connectionCount': '{count} connections',
  'terminal.newTabMenu.recentConnections': 'Recent connections',
  'terminal.newTabMenu.newConnection': 'New Connection',
  'terminal.newTabMenu.openWorkbench': 'Open Workbench',
  'terminal.newTabMenu.personal': 'Personal',
