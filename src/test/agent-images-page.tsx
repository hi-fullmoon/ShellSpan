...
export async function mountImagesPage(root: HTMLElement) {
  ...
  createRoot(root).render(<main className="ai-panel-shell" data-ai-scope="terminal" data-stage6c-ready style={{ width: '100vw', height: '100vh' }}><AiWorkspaceController scope="terminal" /></main>);
}
