...
function buildPowerShellWrapper(
  ...
  const commandBootstrap = [
    ...
    '$__shellspanChildOk=$false',
    '$__shellspanChildNative=$null',
    "$__shellspanChildScript=[ScriptBlock]::Create($__shellspanCommand+[Environment]::NewLine+'$__shellspanChildOk=$?;$__shellspanChildNative=$global:LASTEXITCODE')",
