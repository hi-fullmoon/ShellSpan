...
interface StaticDiagnosticState {
...
/**
 * Frontend-owned legacy fallback. This store only parses a static diagnostic
 * plan and never represents or advances a dynamic P1 Agent run.
 */
export const useStaticDiagnosticStore = create<StaticDiagnosticState>()((set) => ({
  beginRun: (
    requestId,
    goal,
    sessionId,
